...
const myths = [
  ...
  },
  {
    ...
    history: "Magatsu-Izanagi (禍津伊弉諾) means \"Calamity Izanagi.\" This refers to Izanagi's state before he washed away the filth from Yomotsu Hirasaka in a failed mission to retrieve his late consort, Izanami.\n\nMagatsu-Izanagi also represents \"Emptiness.\"\n",
    origins: ['Japanese'],
  },
  {
  ...
  {
    name: 'Tsukuyomi',
    history: "Tsukuyomi is the lunar god in Shintoism. He was born of Izanagi's right eye as he bathed after his descent to the underworld, thus making him the brother of Amaterasu and Susano-o.\n",
    origins: ['Japanese'],
  },
  {

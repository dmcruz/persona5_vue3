...
const persona5DataRoyal = {
  ...
  Agathion: {
    ...
    elems: ['-', 'rs', '-', '-', 'rs', 'wk', '-', '-', '-', '-'],
    skills: {
      Dia: 0, Baisudi: 0, Lunge: 4, Rakukaja: 6, Zio: 7, 'Dodge Elec': 8,
    },
    stats: [3, 4, 5, 7, 3],
    trait: 'Odd Immunity',
  },
  ...
  'Ame-no-Uzume': {
    ...
    elems: ['-', '-', 'ab', '-', '-', '-', 'wk', '-', '-', '-'],
    skills: {
      Mazio: 0, Magaru: 0, Media: 0, 'Nocturnal Flash': 15, Baisudi: 16, 'Divine Grace': 18,
    },
    stats: [7, 10, 9, 11, 9],
    trait: 'Elec Lineage',
  },
  ...
  Angel: {
    ...
    elems: ['-', 'wk', '-', '-', 'rs', '-', '-', '-', 'nu', 'wk'],
    skills: {
      Kouha: 0, Makajam: 0, Dia: 0, Baisudi: 10, 'Dodge Curse': 11, Dekunda: 12,
    },
    stats: [6, 9, 5, 9, 5],
  ...
  Anubis: {
    ...
    elems: ['-', 'rs', '-', '-', '-', '-', 'rs', '-', 'nu', 'nu'],
    skills: {
      Hamaon: 0, Mudoon: 0, Makouga: 0, Maeiga: 36, Dekunda: 37, 'Resist Bless': 38,
    },
  ...
  Anzu: {
    ...
    elems: ['-', 'wk', '-', '-', 'rs', 'rp', '-', 'wk', '-', '-'],
    skills: {
      Garula: 0, Masukukaja: 0, 'Wind Break': 0, 'Assault Dive': 27, Dekaja: 28, 'Null Forget': 29,
    },
  ...
  Apsaras: {
    ...
    elems: ['-', '-', 'wk', 'rs', 'wk', '-', '-', '-', '-', '-'],
    skills: {
      Rebellion: 0, 'Ice Wall': 0, Bufu: 0, Media: 13, 'Elec Wall': 14, 'Wind Wall': 16,
    },
    stats: [7, 11, 6, 10, 6],
    trait: 'Self Hypnosis',
  },
  ...
  Archangel: {
    ...
    elems: ['-', '-', '-', '-', 'wk', '-', '-', '-', 'nu', 'wk'],
    skills: {
      'Giant Slice': 0, Dazzler: 0, Hama: 0, Rebellion: 16, 'Power Slash': 17, 'Vajra Blast': 19,
    },
    stats: [11, 9, 10, 12, 7],
    trait: 'Chained Technique',
  },
  ...
  Arsene: {
    ...
    elems: ['-', '-', '-', 'wk', '-', '-', '-', '-', 'wk', 'rs'],
    skills: {
      Eiha: 0, Cleave: 2, Sukunda: 4, 'Dream Needle': 5, 'Adverse Resolve': 7,
    },
    stats: [2, 2, 2, 3, 1],
    trait: 'Last Stand',
  },
  ...
  Barong: {
    ...
    skills: {
      Ziodyne: 0, 'Wage War': 0, 'Invigorate 2': 0, 'Elec Break': 54, 'Null Elec': 55, Maziodyne: 57,
    },
  ...
  Belphegor: {
    ...
    skills: {
      Mabufula: 0, 'Ice Break': 0, 'Null Rage': 38, 'Dodge Fire': 39, Bufudyne: 41, Concentrate: 42,
    },
  ...
  Berith: {
    ...
    elems: ['-', 'nu', 'rs', 'wk', '-', '-', '-', '-', '-', '-'],
    skills: {
      Cleave: 0, Rakukaja: 0, Tarukaja: 10, 'Dodge Fire': 11, 'Power Slash': 13,
    },
    stats: [9, 6, 8, 8, 3],
  ...
  Bicorn: {
    ...
    elems: ['-', '-', '-', '-', 'wk', '-', '-', '-', '-', 'rs'],
    skills: {
      Lunge: 0, Tarunda: 0, Garu: 6, 'Ice Wall': 7, 'Apt Pupil': 8,
    },
    stats: [5, 3, 3, 5, 3],
    trait: 'Heavyweight',
  },
  ...
  'Cait Sith': {
    ...
    elems: ['-', '-', '-', '-', 'rs', 'wk', '-', '-', '-', '-'],
    skills: {
      Agi: 0, Cleave: 0, Tarukaja: 0, 'Resist Sleep': 6, Sukukaja: 7, Media: 9,
    },
    stats: [6, 4, 4, 5, 3],
    trait: 'Burning Touch',
  },
  ...
  'Fuu-Ki': {
    ...
    elems: ['-', 'rs', '-', '-', 'wk', 'ab', '-', '-', '-', '-'],
    skills: {
      'Tetra Break': 0, Tarukaja: 0, Garula: 0, 'Wind Boost': 25, Magarula: 26, 'Resist Wind': 27,
    },
  ...
  Genbu: {
    ...
    elems: ['-', '-', '-', 'nu', 'wk', '-', 'rs', '-', '-', '-'],
    skills: {
      Bufu: 0, Rakunda: 0, Patra: 8, 'Resist Forget': 9, Mabufu: 10, 'Defense Master': 12,
    },
    stats: [5, 6, 7, 6, 4],
  ...
  Girimehkala: {
    ...
    skills: {
      Mudoon: 0, Marakunda: 0, Deathbound: 0, Agidyne: 46, 'Wage War': 47, 'Repel Phys': 50,
    },
  ...
  'High Pixie': {
    ...
    elems: ['-', 'wk', '-', '-', 'rs', 'rs', '-', 'wk', '-', '-'],
    skills: {
      Garu: 0, Media: 0, Dormina: 0, Diarama: 19, Pulinpa: 20, Magaru: 22,
    },
    stats: [8, 14, 10, 13, 10],
    trait: 'Chained Technique',
  },
  ...
  'Hua Po': {
    ...
    elems: ['-', 'wk', 'rp', 'wk', '-', '-', '-', '-', '-', '-'],
    skills: {
      Agi: 0, Dormina: 0, Tarunda: 11, 'Resist Forget': 12, Maragi: 13, 'Burn Boost': 15,
    },
    stats: [4, 10, 4, 8, 8],
    trait: 'Burning Touch',
  },
  Incubus: {
    ...
    elems: ['-', '-', 'wk', '-', 'rs', '-', '-', '-', 'wk', '-'],
    skills: {
      'Life Drain': 0, 'Dream Needle': 0, Dormina: 7, Tarunda: 8, 'Dodge Curse': 9,
    },
    stats: [4, 6, 4, 5, 3],
    trait: 'Bloodsucker',
  },
  ...
  'Jack Frost': {
    ...
    elems: ['-', '-', 'wk', 'nu', '-', '-', '-', '-', '-', '-'],
    skills: {
      Bufu: 0, 'Ice Break': 0, Baisudi: 0, Mabufu: 12, Rakunda: 13, 'Freeze Boost': 15,
    },
    stats: [8, 9, 7, 9, 7],
    trait: 'Ice Lineage',
  },
  "Jack-o'-Lantern": {
    ...
    elems: ['-', '-', 'ab', 'wk', '-', 'wk', '-', '-', '-', '-'],
    skills: {
      Agi: 0, Rakunda: 0, 'Sharp Student': 4, Dazzler: 5, 'Resist Sleep': 7,
    },
    stats: [2, 3, 3, 3, 2],
    trait: 'Burning Touch',
  },
  ...
  Kelpie: {
    ...
    elems: ['-', '-', '-', 'rs', 'wk', '-', '-', '-', '-', '-'],
    skills: {
      Garu: 0, Lunge: 0, 'Resist Brainwash': 8, Sukukaja: 9, 'Terror Claw': 10,
    },
    stats: [5, 5, 5, 6, 4],
    trait: 'Heavyweight',
  },
  'Kikuri-Hime': {
    ...
    elems: ['-', '-', 'wk', '-', '-', 'nu', '-', '-', 'rs', '-'],
    skills: {
      Lullaby: 0, Marakukaja: 0, 'Energy Drop': 0, Mediarama: 41, Tetraja: 43, 'Divine Grace': 45,
    },
  ...
  'Koppa Tengu': {
    ...
    elems: ['-', '-', '-', 'wk', '-', 'rs', '-', '-', 'wk', '-'],
    skills: {
      Garu: 0, Sukukaja: 0, 'Growth 1': 12, Taunt: 13, 'Rage Boost': 13, 'Wage War': 15,
    },
    stats: [7, 8, 8, 11, 6],
    trait: 'Focused Gaze',
  },
  ...
  'Kurama Tengu': {
    ...
    elems: ['-', '-', '-', 'nu', '-', 'rp', '-', '-', 'rs', 'rs'],
    skills: {
      'Double Shot': 0, Masukunda: 0, Magarula: 0, 'Wind Boost': 32, 'Brain Jack': 34, 'Growth 2': 36,
    },
  ...
  'Kushi Mitama': {
    ...
    elems: ['-', '-', 'wk', '-', '-', 'rs', '-', '-', '-', '-'],
    skills: {
      Dia: 0, Media: 0, Makajam: 0, 'Regenerate 1': 13, 'Wind Wall': 14, 'Forget Boost': 16,
    },
    stats: [7, 11, 9, 8, 8],
    trait: 'Life Focus',
  },
  ...
  'Leanan Sidhe': {
    ...
    elems: ['-', '-', 'wk', '-', '-', 'rs', 'rs', '-', '-', '-'],
    skills: {
      Rakunda: 0, Psio: 0, 'Marin Karin': 20, Mamudo: 21, Mapsi: 22, Eiga: 23,
    },
    stats: [9, 17, 12, 16, 10],
  ...
  Mandrake: {
    ...
    elems: ['-', '-', 'wk', '-', 'rs', '-', '-', '-', '-', '-'],
    skills: {
      Pulinpa: 0, 'Energy Drop': 0, Lunge: 4, Sukunda: 5, 'Skull Cracker': 7,
    },
    stats: [2, 3, 3, 4, 4],
    trait: 'Recovery Lineage',
  },
  ...
  Matador: {
    ...
    elems: ['-', '-', '-', '-', 'wk', 'nu', '-', '-', '-', '-'],
    skills: {
      Psi: 0, 'Null Dizzy': 0, Sukukaja: 0, Mapsi: 18, 'Double Shot': 20, 'Swift Strike': 22,
    },
    stats: [11, 13, 10, 16, 8],
    trait: 'Group Hypnosis',
  },
  ...
  'Nigi Mitama': {
    ...
    elems: ['-', '-', '-', '-', 'wk', '-', '-', '-', 'rs', 'rs'],
    skills: {
      Baisudi: 0, Diarama: 0, Makouha: 0, 'Divine Grace': 24, 'Me Patra': 25, 'Climate Decorum': 26,
    },
  ...
  Obariyon: {
    ...
    elems: ['rs', '-', '-', '-', 'wk', '-', '-', '-', '-', '-'],
    skills: {
      Snap: 0, Sukunda: 0, 'Lucky Punch': 9, 'Resist Fear': 10, Dekaja: 12,
    },
    stats: [7, 3, 9, 8, 4],
    trait: 'Heavyweight',
  },
  ...
  Oni: {
    ...
    elems: ['rs', 'rs', '-', '-', '-', '-', '-', '-', '-', '-'],
    skills: {
      Rampage: 0, Counter: 0, Snap: 0, 'Giant Slice': 22, 'Sharp Student': 23, 'Memory Blow': 24,
    },
    stats: [19, 9, 17, 12, 10],
    trait: 'Avenger',
  },
  Onmoraki: {
    ...
    elems: ['-', '-', 'rs', 'wk', '-', '-', '-', '-', 'wk', 'nu'],
    skills: {
      Eiha: 0, 'Ice Wall': 0, Agi: 13, 'Evil Touch': 14, Pulinpa: 15, 'Confuse Boost': 17,
    },
    stats: [9, 12, 7, 10, 5],
    trait: 'Focused Gaze',
  },
  ...
  Orobas: {
    ...
    elems: ['-', '-', '-', 'wk', '-', 'rs', '-', '-', '-', 'rs'],
    skills: {
      Maragi: 0, Sukukaja: 0, Dekaja: 0, Marakunda: 19, 'Fire Break': 20, Makajamaon: 21,
    },
    stats: [11, 14, 15, 12, 6],
    trait: 'Peerless Gaze',
  },
  ...
  Phoenix: {
    ...
    elems: ['-', '-', '-', 'rs', 'wk', 'nu', '-', '-', '-', '-'],
    skills: {
      Freila: 0, 'Dream Needle': 0, Diarama: 22, Recarm: 23, 'Nuke Boost': 25, Mafreila: 26,
    },
  ...
  Pixie: {
    ...
    skills: {
      Zio: 0, Dia: 0, Patra: 3, Tarukaja: 4, 'Resist Confuse': 5,
    },
    stats: [1, 3, 3, 4, 2],
    trait: 'Shocking Follow-up',
  },
  ...
  Rangda: {
    ...
    skills: {
      'Swift Strike': 0, Bloodbath: 0, Counterstrike: 0, Eigaon: 49, Matarunda: 51, Mudoon: 53,
    },
  ...
  'Saki Mitama': {
    ...
    elems: ['-', '-', '-', 'rs', '-', 'wk', '-', '-', '-', '-'],
    skills: {
      Bufu: 0, 'Energy Drop': 0, 'Wind Wall': 0, 'Growth 1': 7, Rakukaja: 8, 'Resist Dizzy': 10,
    },
    stats: [4, 6, 5, 6, 4],
    trait: 'Self Hypnosis',
  },
  ...
  Setanta: {
    ...
    elems: ['-', 'rs', '-', '-', '-', '-', 'wk', 'rs', '-', '-'],
    skills: {
      'Giant Slice': 0, 'Dormin Rush': 0, Counter: 0, Charge: 27, Rebellion: 29, 'Rising Slash': 30,
    },
  ...
  Silky: {
    ...
    elems: ['-', '-', 'wk', 'rs', 'wk', '-', '-', '-', '-', '-'],
    skills: {
      Dormina: 0, Bufu: 0, Dia: 7, Patra: 9, 'Sharp Student': 10,
    },
    stats: [4, 7, 4, 5, 5],
    trait: 'Focused Gaze',
  },
  ...
  Slime: {
    ...
    elems: ['rs', 'rs', 'wk', '-', '-', 'wk', '-', '-', '-', '-'],
    skills: {
      Lunge: 0, 'Evil Touch': 0, Tarunda: 11, 'Fire Wall': 13, Headbutt: 14,
    },
    stats: [9, 6, 11, 6, 5],
    trait: 'Odd Immunity',
  },
  ...
  Succubus: {
    ...
    elems: ['-', '-', 'rs', '-', '-', 'wk', '-', '-', 'wk', 'nu'],
    skills: {
      Dormina: 0, Rebellion: 0, Agi: 8, Dekaja: 10, 'Sleep Boost': 11, Mudo: 12,
    },
    stats: [4, 7, 5, 8, 4],
    trait: 'Foul Contagion',
  },
  ...
  Thunderbird: {
    ...
    elems: ['-', '-', '-', '-', 'ab', '-', 'wk', '-', '-', 'wk'],
    skills: {
      Mazionga: 0, Tarukaja: 0, 'Shock Boost': 0, Rebellion: 35, Ziodyne: 37, 'Elec Boost': 38,
    },
  ...
  Titania: {
    ...
    elems: ['-', '-', '-', '-', '-', '-', 'wk', 'rs', 'rs', 'rs'],
    skills: {
      Freidyne: 0, Ziodyne: 0, Lullaby: 0, Concentrate: 59, 'Nuke Amp': 60, Mediarahan: 61,
    },
